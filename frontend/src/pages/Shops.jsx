        ...
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
          <div className={` md:block hidden ${!filter ? "mb-6" : "mb-0"} `}>
            <button
              ...
              className="text-center w-full py-2 px-3 bg-primary hover:bg-primary-dark text-white rounded-md transition-colors"
            >
              Filter Product
            </button>
          </div>
            ...
            >
              ...
              <div className="py-2">
                {categorys.map((c, i) => (
                  <div
                    key={i}
                    className="flex justify-between items-center gap-2 py-2 px-2 rounded-md hover:bg-gray-50 transition-colors"
                  >
                    <div className="flex justify-start items-center gap-2">
                      ...
                      />
                      <label
                        className="text-slate-600 block cursor-pointer font-medium"
                        htmlFor={c.name}
                      >
                        {c.name}
                      </label>
              ...
              <div className="py-3 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  <div
                    onClick={() => setRating(5)}
                    className="text-primary flex justify-start items-start gap-2 text-xl cursor-pointer hover:text-primary-dark transition-colors"
                  >
                    <span>
                      <AiFillStar />{" "}
                    </span>
              ...
              <div className="pl-8 md:pl-0">
                ...
                <div className="py-4 bg-white mb-10 px-3 rounded-md flex flex-col md:flex-row justify-between items-start gap-4 border">
                  <div className="flex flex-col md:flex-row items-start md:items-center gap-4 flex-1">
                    ...
                    {(state.values[0] !== priceRange.low ||
                      state.values[1] !== priceRange.high) && (
                      <div className="flex items-center gap-2">

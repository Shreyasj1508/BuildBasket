...
const Register = () => {
    ...
    <div className='flex flex-col gap-1 mb-2'>
        ...
        <input onChange={inputHandle} value={state.name} className='input-field' type="text" name="name" id="name" placeholder='Name' required />
    </div>

    <div className='flex flex-col gap-1 mb-2'>
        <label htmlFor="email">Email</label>
        <input onChange={inputHandle} value={state.email} className='input-field' type="email" name="email" id="email" placeholder='Email' required />
    </div>


    <div className='flex flex-col gap-1 mb-2'>
        <label htmlFor="password">Password</label>
        <input onChange={inputHandle} value={state.password} className='input-field' type="password" name="password" id="password" placeholder='Password' required />
    </div>

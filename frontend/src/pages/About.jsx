    ...
    return (
        <div className='min-h-screen bg-gray-50'>
            ...
            <div className='w-[90%] lg:w-[85%] mx-auto py-16 px-4'>
                {/* Company Story */}
                <div className='mb-20'>
                    <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-12 text-center'>Our Story</h2>
                    <div className='grid lg:grid-cols-2 gap-12 lg:gap-16 items-start'>
                        ...
                        <div className='bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100'>
                            <h3 className='text-xl sm:text-2xl font-bold text-primary mb-6 text-center'>Why Choose Us?</h3>
                            <ul className='space-y-4'>
                                <li className='flex items-start gap-3'>
                                    <div className='w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                                    <span className='text-gray-700 leading-relaxed'>Quality guaranteed materials</span>
                                </li>
                                <li className='flex items-start gap-3'>
                                    <div className='w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                                    <span className='text-gray-700 leading-relaxed'>Competitive pricing</span>
                                </li>
                                <li className='flex items-start gap-3'>
                                    <div className='w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                                    <span className='text-gray-700 leading-relaxed'>Fast and reliable delivery</span>
                                </li>
                                <li className='flex items-start gap-3'>
                                    <div className='w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0'></div>
                                    <span className='text-gray-700 leading-relaxed'>Expert customer support</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className='grid lg:grid-cols-2 gap-8 lg:gap-12 mb-20'>
                    <div className='bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100 h-full'>
                        <h3 className='text-xl sm:text-2xl font-bold text-primary mb-6 text-center'>Our Mission</h3>
                    ...
                    <div className='bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100 h-full'>
                        <h3 className='text-xl sm:text-2xl font-bold text-primary mb-6 text-center'>Our Vision</h3>
                        <p className='text-gray-600 leading-relaxed text-center'>
                ...
                <div className='text-center mb-20'>
                    <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-12'>Our Values</h2>
                    <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8'>
                        <div className='bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100 h-full flex flex-col items-center text-center'>
                            ...
                            <h4 className='text-lg sm:text-xl font-bold text-gray-800 mb-3'>Quality</h4>
                            <p className='text-gray-600 text-sm sm:text-base leading-relaxed'>We never compromise on the quality of materials</p>
                        </div>
                        <div className='bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100 h-full flex flex-col items-center text-center'>
                            <div className='w-16 h-16 sm:w-20 sm:h-20 bg-primary rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6'>
                                <span className='text-white text-xl sm:text-2xl font-bold'>T</span>
                            </div>
                            <h4 className='text-lg sm:text-xl font-bold text-gray-800 mb-3'>Trust</h4>
                            <p className='text-gray-600 text-sm sm:text-base leading-relaxed'>Building trust through transparency and reliability</p>
                        </div>
                        <div className='bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100 h-full flex flex-col items-center text-center'>
                            <div className='w-16 h-16 sm:w-20 sm:h-20 bg-primary rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6'>
                                <span className='text-white text-xl sm:text-2xl font-bold'>I</span>
                            </div>
                            <h4 className='text-lg sm:text-xl font-bold text-gray-800 mb-3'>Innovation</h4>
                            <p className='text-gray-600 text-sm sm:text-base leading-relaxed'>Continuously improving our platform and services</p>
                        </div>
                        <div className='bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-100 h-full flex flex-col items-center text-center'>
                            <div className='w-16 h-16 sm:w-20 sm:h-20 bg-primary rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6'>
                                <span className='text-white text-xl sm:text-2xl font-bold'>S</span>
                            </div>
                            <h4 className='text-lg sm:text-xl font-bold text-gray-800 mb-3'>Service</h4>
                            <p className='text-gray-600 text-sm sm:text-base leading-relaxed'>Exceptional customer service is our priority</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='bg-white p-6 sm:p-8 lg:p-12 rounded-xl shadow-lg border border-gray-100 text-center'>
                    <h2 className='text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-8 sm:mb-12'>Get in Touch</h2>
                    <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12'>
                        <div className='flex flex-col items-center'>
                            ...
                            <h4 className='text-lg sm:text-xl font-bold text-primary mb-2 sm:mb-3'>Email</h4>
                            <p className='text-gray-600 text-sm sm:text-base break-all'>{aboutData?.contactInfo?.email || 'support@buildbasket.com'}</p>
                        </div>
                        <div className='flex flex-col items-center'>
                            <div className='w-12 h-12 sm:w-16 sm:h-16 bg-primary rounded-full flex items-center justify-center mx-auto mb-4'>
                                <svg className='w-6 h-6 sm:w-8 sm:h-8 text-white' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                            ...
                            <h4 className='text-lg sm:text-xl font-bold text-primary mb-2 sm:mb-3'>Phone</h4>
                            <p className='text-gray-600 text-sm sm:text-base'>{aboutData?.contactInfo?.phone || '+(123) 3243 343'}</p>
                        </div>
                        <div className='flex flex-col items-center sm:col-span-2 lg:col-span-1'>
                            ...
                            <h4 className='text-lg sm:text-xl font-bold text-primary mb-2 sm:mb-3'>Address</h4>
                            <p className='text-gray-600 text-sm sm:text-base text-center'>{aboutData?.contactInfo?.address || 'Construction Hub, Building Materials District'}</p>
                        </div>
                    </div>
                </div>
            </div>

   ...
   <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
    ...
    <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
            ...
            <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                ...
                <div className='flex justify-between items-center'>
                    <span>Total</span>
                    <span className='text-lg text-primary font-bold'>${price + shipping_fee} </span>
                </div>
                <button onClick={placeOrder} disabled={res ? false : true} className={`btn-primary w-full text-sm uppercase ${!res ? 'opacity-50 cursor-not-allowed' : ''}`}>
                   Place Order 
                </button>

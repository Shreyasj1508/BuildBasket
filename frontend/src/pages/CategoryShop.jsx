        ...
        <div className='py-2 flex flex-col gap-5'>
         ...
         <div className='py-3 flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-3'>
                 <div onClick={() => setRating(5)} className='text-[#eba834] flex justify-start items-start gap-2 text-xl cursor-pointer'>
                  ...
                  <div onClick={() => setRating(4)} className='text-[#eba834] flex justify-start items-start gap-2 text-xl cursor-pointer'>
                    <span><AiFillStar/> </span>
                    <span><AiFillStar/> </span>
                    <span><AiFillStar/> </span>
                    <span><AiFillStar/> </span>
                  ...
                  <div onClick={() => setRating(3)} className='text-[#eba834] flex justify-start items-start gap-2 text-xl cursor-pointer'>
                    <span><AiFillStar/> </span>
                    <span><AiFillStar/> </span>
                    <span><AiFillStar/> </span>
                    <span><CiStar/> </span>
                  ...
                  <div onClick={() => setRating(2)} className='text-[#eba834] flex justify-start items-start gap-2 text-xl cursor-pointer'>
                    <span><AiFillStar/> </span>
                    <span><AiFillStar/> </span>
                    <span><CiStar/> </span>
                    <span><CiStar/> </span>
                  ...
                  <div onClick={() => setRating(1)} className='text-[#eba834] flex justify-start items-start gap-2 text-xl cursor-pointer'>
                    <span><AiFillStar/> </span>
                    <span><CiStar/> </span>
                    <span><CiStar/> </span>
                    <span><CiStar/> </span>
                  ...
                  <div onClick={resetRating} className='text-[#eba834] flex justify-start items-start gap-2 text-xl cursor-pointer'>
                  <span><CiStar/> </span>
                  <span><CiStar/> </span>
                  <span><CiStar/> </span>
                  <span><CiStar/> </span>

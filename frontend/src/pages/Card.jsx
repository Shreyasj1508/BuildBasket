...
const Card = () => {
   ...
   <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
       ...
       <div className='flex gap-2 flex-col'>
           ...
           <button onClick={() => dispatch(delete_card_product(pt._id)) } className='px-5 py-[3px] bg-red-500 hover:bg-red-600 text-white rounded transition-colors'>Delete</button>
       </div>
   </div>
   ...
   <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
       ...
       <div className='flex gap-2 flex-col'>
           ...
           <button onClick={() => dispatch(delete_card_product(p._id)) }  className='px-5 py-[3px] bg-red-500 hover:bg-red-600 text-white rounded transition-colors'>Delete</button>
       </div>
   </div>
    ...
    <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
        {
            card_products.length > 0 && <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                ...
                <button className='px-5 py-[1px] bg-primary hover:bg-primary-dark text-white rounded-sm uppercase text-sm transition-colors'>Apply</button>
                </div>
                ...
                <button onClick={redirect} className='btn-primary w-full text-sm uppercase'>

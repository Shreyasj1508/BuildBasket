...
const OrderManagement = () => {
    ...
    const handleApproveOrder = async (orderId) => {
        try {
            const response = await fetch(`/api/admin/approve-order/${orderId}`, {
                method: 'PUT',
                headers: {
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-gray-600">Review and approve pending orders from customers</p>
                        </div>
                                    ...
                                    <div className="flex justify-between items-start">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-4 mb-4">
                                                ...
                                                {getStatusBadge(order.adminApproval?.status || 'pending')}
                                            </div>
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex gap-4 justify-end">
                                ...
                                <button
                                    ...
                                    className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-xl transition-colors flex items-center gap-2"
                                >
                                    <FaCheckCircle />
                                    Approve Order
                                </button>

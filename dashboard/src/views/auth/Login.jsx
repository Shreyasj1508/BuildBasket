...
const Login = () => {
    ...
    useEffect(() => {
        console.log('Login useEffect - successMessage:', successMessage, 'errorMessage:', errorMessage)
    ...
    return (
                ...
                <div className="relative w-full max-w-sm animate-scaleIn">
                    ...
                    <div className="text-center mb-6 animate-fadeInUp">
                        ...
                        <div className="flex items-center justify-center gap-2 mb-1">
                            ...
                            <p className="text-gray-700 font-bold text-sm">Seller Portal</p>
                            <div className="w-1.5 h-1.5 bg-[#d17a1e] rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
                        </div>
                        <p className="text-gray-600 font-medium text-xs">Welcome to Ecommerce Platform</p>
                    </div>
                    ...
                    <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-white/20 animate-slideInLeft" style={{ animationDelay: '0.3s' }}>
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        placeholder="seller@buildbasket.com"
                                        required
                                    />
                                </div>
        </div>
                            ...
                            <div className='flex items-center justify-center gap-2 text-xs'>
                                ...
                                <Link className='font-bold text-[#eb8f34] hover:text-[#d17a1e] transition-colors' to="/register">Sign Up</Link>
        </div>
        ...
        <div className='flex justify-center items-center gap-3'>
                                <div className='w-[135px] h-[35px] flex rounded-lg bg-gradient-to-r from-[#eb8f34] to-[#d17a1e] shadow-lg hover:shadow-xl justify-center cursor-pointer items-center transition-all duration-300 hover:scale-105'>
                                    <FaGoogle className="text-white text-sm" />
             </div>
                                <div className='w-[135px] h-[35px] flex rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 shadow-lg hover:shadow-xl justify-center cursor-pointer items-center transition-all duration-300 hover:scale-105'>
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-200">
                            <div className="flex items-center justify-center gap-2 text-xs text-gray-600">
                                <div className="flex items-center gap-1">
                                    ...
                                    <span className="font-semibold">Secure seller access</span>
                                </div>
                            </div>
